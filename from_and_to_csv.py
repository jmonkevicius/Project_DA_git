...
class Csv2Sqlite(object):
    ...
    def convert_test(filepath_or_fileobj, connection, cursor, table):
        print(filepath_or_fileobj)
        #print(dbpath)
        print(table)
        ...
        types = Csv2Sqlite._guess_types(reader)
        fo.seek(0)
...
class Sqlite2Csv(object):
    def convert(connection, cursor):
